...
echo "Moving files"
mv step1_${1}_${2}.root /eos/cms/store/group/dpg_hgcal/comm_hgcal/hackathon/samples/close_by_single_electron/production/step1_${1}_${2}.root
mv step2_${1}_${2}.root /eos/cms/store/group/dpg_hgcal/comm_hgcal/hackathon/samples/close_by_single_electron/production/step2_${1}_${2}.root
mv step3_${1}_${2}.root /eos/cms/store/group/dpg_hgcal/comm_hgcal/hackathon/samples/close_by_single_electron/production/step3_${1}_${2}.root
