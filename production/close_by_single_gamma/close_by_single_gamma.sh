...
echo "Run step 1"
cmsRun -n 4 ticl_hackathon/production/step1.py filename=step1_$1_$2.root Nevents=10 PID=$pid Emin=$emin Emax=$emax Etamin=$etamin Etamax=$etamax seed=$seed
...
echo "Moving files"
mv step1_${1}_${2}.root /eos/cms/store/group/dpg_hgcal/comm_hgcal/hackathon/samples/close_by_single_gamma/condor_production/step1_${1}_${2}.root
mv step2_${1}_${2}.root /eos/cms/store/group/dpg_hgcal/comm_hgcal/hackathon/samples/close_by_single_gamma/condor_production/step2_${1}_${2}.root
mv step3_${1}_${2}.root /eos/cms/store/group/dpg_hgcal/comm_hgcal/hackathon/samples/close_by_single_gamma/condor_production/step3_${1}_${2}.root
