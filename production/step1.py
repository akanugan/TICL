...
# with command line options: CE_E_Front_300um_cfi -s GEN,SIM -n 10 --conditions auto:phase2_realistic_T21 --beamspot HGCALCloseBy --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry Extended2026D76 --era Phase2C11I13M9 --relval 9000,100 --no_exec --fileout file:step1.root
...
process.generator = cms.EDProducer("CloseByParticleGunProducer",
    ...
    PGunParameters = cms.PSet(
        ...
        Overlapping = cms.bool(options.overlapping),
        PartID = cms.vint32(options.PID),
